...
const SignUpForm = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-[url('/darkpt.png')] bg-center bg-[#16131b] overflow-hidden">
      ...
      <div className="w-full min-h-screen bg-[url('/darkpt.png')] bg-center bg-[#16131b]">
              ...
              <div className="flex flex-col gap-4 px-4 mt-4">
                <div className="relative">
                  <input
                    ...
                    className="border-1 border-gray-600 w-full pl-5 pr-4 py-2 rounded-md bg-[#303137] text-white placeholder-gray-300 outline-none transition-colors ease-in-out duration-500 focus:border-teal-600"
                  />
                </div>
                ...
                <div className="mt-5 flex justify-center items-center">
                  <button
                    className=" bg-teal-600 px-7 py-3 rounded-xl text-white uppercase transition-colors hover:bg-teal-800 duration-700 hover:text-gray-400 cursor-pointer font-semibold disabled:cursor-not-allowed disabled:bg-gray-400 disabled:text-black"
                    disabled
                  >
                    Sign Up
                  </button>
