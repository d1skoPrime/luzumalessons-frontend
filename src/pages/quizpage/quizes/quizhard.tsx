...
import { QuizHard, type QuizQuestion } from '../../../types/types';
...
const QuizHhard = () => {
  ...
  useEffect(() => {
    const shuffled = QuizHard.map((q: any) => {
        ...
        {!finished ? (
          ...
          <div className="text-center">
            ...
            <h2 className="text-white font-bold">
              Quiz Level: <span className="text-red-500">Hard</span>
            </h2>
            ...
            <button
              onClick={() => {
                ...
                // Reshuffle again
                const reshuffled = QuizHard.map((q: any) => {
                  const options = shuffleArray(q.options);
                  const correctIndexInShuffled = options.indexOf(
                    q.options[q.correctAnswerIndex],
                  );
